...
@Component({
  selector: 'app-positions-certifications',
  templateUrl: './positions-certifications.component.html',
  styleUrls: ['./positions-certifications.component.scss']
})
export class PositionsCertificationsComponent implements OnInit, OnDestroy, AfterViewInit {
