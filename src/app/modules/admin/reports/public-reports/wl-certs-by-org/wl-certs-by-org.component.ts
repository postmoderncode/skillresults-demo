...
@Component({
  selector: 'app-wl-certs-by-org',
  templateUrl: './wl-certs-by-org.component.html',
  styleUrls: ['./wl-certs-by-org.component.scss']
})

export class WlCertsByOrgComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    ...
    this.items = this.db.list('/wishlists/certifications').snapshotChanges().subscribe(
      (results) => {
