...
@Component({
  selector: 'app-skills-by-org',
  templateUrl: './skills-by-org.component.html',
  styleUrls: ['./skills-by-org.component.scss']
})
export class SkillsByOrgComponent implements OnInit, AfterViewInit, OnDestroy {
