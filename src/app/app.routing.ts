        ...
        children: [
            ...
            // Reports Areas
            {
                path: 'reports', children: [
                    ...
                    { path: 'public-reports/:id', loadChildren: () => import('app/modules/admin/reports/public-reports/public-reports.module').then(m => m.PublicReportsModule) },
                ]
            },
            ...
            // Teams Areas
            {
                ...
                path: 'teams', loadChildren: () => import('app/modules/admin/teams/teams.module').then(m => m.TeamsModule),
